...
{    
    ...
    protected static final String BUILDVERSION = "Marketwatch 1.0.2";    
    ...
    private void SetTrayIcon()
    {
        if (SystemTray.isSupported())
        {
            ...
            trayIcon = new TrayIcon(icon, "Marketwatch", popup);
            ...
            exitItem.addActionListener((ActionEvent e) ->{GUI.exitInitiated(false);});//checks for reqording
            popup.add(guiItem);
            popup.add(exitItem);
